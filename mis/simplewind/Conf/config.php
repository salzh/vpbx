...
$configs= array(
		...
		'APP_GROUP_LIST'        => 'Core,App,User',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
	    'APP_GROUP_MODE'        =>  1,  // 分组模式 0 普通分组 1 独立分组
	    'APP_GROUP_PATH'        =>  '../application', // 分组目录 独立分组模式下面有效
 		'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题
 		'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀
 		'DEFAULT_GROUP'         => 'Core',  // 默认分组
 		'DEFAULT_MODULE'        => 'Domains', // 默认模块名称
		...
		'TMPL_L_DELIM'			=>'[{', //标签默认开始标记
		'TMPL_R_DELIM'			=>'}]', //标签默认结束标记
