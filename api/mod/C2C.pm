...
sub makepowercall {
	...
	$cmd_str = "bgapi originate {origination_caller_id_name=callback-$ext,origination_caller_id_number=$cid,domain_name=$domain_name,autocallback_fromextension=$ext,is_lead=1}$dest_uri conference$ext XML default";
	warn $cmd_str;
	$result = &runswitchcommand('internal', $cmd_str);
